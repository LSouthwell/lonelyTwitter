...
public class ElasticsearchTweetController {
    ...
    public static class GetTweetsTask_original extends AsyncTask<String, Void, ArrayList<Tweet>> {
        @Override
        protected ArrayList<Tweet> doInBackground(String... search_strings) {
            verifyClient();

            //Start our initial arraylist (empty)
            ArrayList<Tweet> tweets = new ArrayList<Tweet>();

            // NOTE: I am making a huge assumption here, that only the first search term will be used
            ...
            for (int i=0;i<tweets.length; i++) {
                ...
                try {
                    ...
                    if (result.isSucceeded()) {
                        // set the ID to tweet  that elastic search told me it was
    ...
    public static void verifyClient(){
        ...
        if(client==null){
            ...
            // TODO: put URL somewhere it would amek sense
